...
<body>
	...
	<form name="RegistrationPage" method="POST" 
			action="addcustomer.php" <!--onsubmit="return check_()"-->>
	...
	<table>
		...
		<td><input type="radio" value="discover" name="CCName">
			<img src="discover.jpg" height="20" width="40"></td><td>&nbsp;</td>
		<td><input type="radio" value="master" name="CCName">
