...
--
-- Host: localhost
-- Generation Time: Nov 20, 2014 at 07:29 PM
...
--
CREATE DATABASE `travelexperts` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `travelexperts`;
...
CREATE TABLE IF NOT EXISTS `agents` (
  ...
  `AgncyAddress` varchar(50) NOT NULL,
  `AgncyCity` varchar(50) NOT NULL,
  `AgncyProv` text NOT NULL,
  `AgncyPostal` varchar(30) NOT NULL,
  `AgncyCountry` text NOT NULL,
  `AgncyPhone` varchar(50) NOT NULL,
...
INSERT INTO `agents` (`AgentId`, `AgtFirstName`, `AgtMiddleInitial`, `AgtLastName`, `AgencyId`, `AgncyAddress`, `AgncyCity`, `AgncyProv`, `AgncyPostal`, `AgncyCountry`, `AgncyPhone`, `AgtBusPhone`, `AgtEmail`, `AgtPosition`) VALUES
(1, 'Janet', NULL, 'Delton', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '(403) 210-7801', 'janet.delton@travelexperts.com', 'Senior Agent'),
(2, 'Judy', NULL, 'Lisle', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '(403) 210-7802', 'judy.lisle@travelexperts.com', 'Intermediate Agent'),
(3, 'Dennis', 'C.', 'Reynolds', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '(403) 210-7843', 'dennis.reynolds@travelexperts.com', 'Junior Agent'),
(4, 'John', NULL, 'Coville', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '(403) 210-7823', 'john.coville@travelexperts.com', 'Intermediate Agent'),
(5, 'Janice', 'W.', 'Dahl', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '(403) 210-7865', 'janice.dahl@travelexperts.com', 'Senior Agent'),
(6, 'Bruce', 'J.', 'Dixon', '2', '110 Main Street', 'Okatokes', 'AB', 'T7R3J5', 'Canada', '4035632381', '(403) 210-7867', 'bruce.dixon@travelexperts.com', 'Intermediate Agent'),
(7, 'Beverly', 'S.', 'Jones', '2', '110 Main Street', 'Okatokes', 'AB', 'T7R3J5', 'Canada', '4035632381', '(403) 210-7812', 'beverly.jones@travelexperts.com', 'Intermediate Agent'),
(8, 'Jane', NULL, 'Merrill', '2', '110 Main Street', 'Okatokes', 'AB', 'T7R3J5', 'Canada', '4035632381', '(403) 210-7868', 'jane.merrill@travelexperts.com', 'Senior Agent'),
(9, 'Brian', 'S.', 'Peterson', '2', '110 Main Street', 'Okatokes', 'AB', 'T7R3J5', 'Canada', '4035632381', '(403) 210-7833', 'brian.peterson@travelexperts.com', 'Junior Agent'),
(10, 'Harry', 'A', 'Bent', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '5874712347', 'hbent@travelexperts.com', 'Junior Agent'),
(11, 'Brad', 'B', 'Michael', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '5874712345', 'bmichael@travelexperts.com', 'Junior Agent'),
(12, 'Celine', 'C', 'Murphy', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '58747112346', 'cmurphy@travelexperts.com', 'Junior Agent'),
(13, 'Lindsay', 'D', 'Peter', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '5874712348', 'lpeter@travelexperts.com', 'Junior Agent'),
(14, 'Tracy', 'E', 'Williams', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '5874712349', 'twilliams@travelexperts.com', 'Senior Agent/Manager'),
(15, 'Wayne', 'F', 'Alexis', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '5874711234', 'walexis@travelexperts.com', 'Intermediate Agent'),
(16, 'Jennifer', 'G', 'King', '1', '1155 8th Ave SW', 'Calgary', 'AB', 'T2P1N3', 'Canada', '4032719873', '5874712344', 'jking@travelexperts.com', 'Intermediate Agent');
...
(315, 'VISA', '2435', '0000-00-00 00:00:00', 186),
(316, 'MC', '243546', '0000-00-00 00:00:00', 187),
(317, 'VISA', '4536453523465778', '0000-00-00 00:00:00', 188),
(318, 'VISA', '4536453523465778', '0000-00-00 00:00:00', 189),
(319, 'VISA', '4536453523465778', '0000-00-00 00:00:00', 190);
...
(186, 'Chris', 'J', 'asdf', 'adsf', 'as', 't1t1t1', 'asdf', '3453434342', '', 'aa@aa.aa', NULL),
(187, 'Kas', 'Kas', 'asdf', 'asdf', 'as', 't1t1t1', 'asdf', '2343242323', '', 'aa@aa.aa', NULL),
(190, 'Worldwide', 'Show', 'main street', 'Calgary', 'AB', 't2t2t2', 'Canada', '4031112222', '', 'aa@aa.aa', NULL);
...
(1, 'Caribbean New Year', '2005-12-25 00:00:00', '2006-01-04 00:00:00', 'Cruise the Caribbean & Celebrate the New Year.', '4800.0000', '400.0000', 'carribbean_newyear.jpg'),
(2, 'Polynesian Paradise', '2005-12-12 00:00:00', '2005-12-20 00:00:00', '8 Day All Inclusive Hawaiian Vacation', '3000.0000', '310.0000', 'poly_para.jpg'),
(3, 'Asian Expedition', '2006-05-14 00:00:00', '2006-05-28 00:00:00', 'Airfaire, Hotel and Eco Tour.', '2800.0000', '300.0000', 'asian_expe.jpg'),
(4, 'European Vacation', '2005-11-01 00:00:00', '2005-11-14 00:00:00', 'Euro Tour with Rail Pass and Travel Insurance', '3000.0000', '280.0000', 'europe_explore.jpg');
...
--
-- Table structure for table `useridpw`
--

DROP TABLE IF EXISTS `useridpw`;
CREATE TABLE IF NOT EXISTS `useridpw` (
  `UserID` varchar(15) CHARACTER SET utf8 NOT NULL,
  `PW` varchar(15) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `CustomerId` int(11) NOT NULL,
  PRIMARY KEY (`PW`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `useridpw`
--

INSERT INTO `useridpw` (`UserID`, `PW`, `CustomerId`) VALUES
('chris', 'Chris123', 0),
('asdf', 'Dd1234', 186),
('Worldwide', 'Ds1234', 190),
('Kas', 'Kas1234', 187);
